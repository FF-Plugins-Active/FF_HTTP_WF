...
UENUM(BlueprintType)
enum class EWfStatusCodes : uint8
{
	...
	Switch_Proxy_306							UMETA(DisplayName = "Switch_Proxy_306"),
...
ENUM_CLASS_FLAGS(EWfStatusCodes)

UENUM(BlueprintType)
enum class EWfContentTypes : uint8
{
	// Applications
...
ENUM_CLASS_FLAGS(EWfContentTypes)